...
- [docs/FAQ.md — "Skills aren't loading on Windows"](https://github.com/career-ops-hq/career-ops/blob/main/docs/FAQ.md) — the canonical answer, kept in sync with the installer.
- [docs/SETUP.md](https://github.com/career-ops-hq/career-ops/blob/main/docs/SETUP.md) — full setup guide.

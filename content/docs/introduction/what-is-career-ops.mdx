...
<Callout title="Want to contribute?">
  Read the [contributing guide](https://github.com/career-ops-hq/career-ops/blob/main/CONTRIBUTING.md) before opening a pull request. The short version: open an issue first to discuss the change, then submit your PR. The maintainers review quickly.
</Callout>

...
**Tracker entries** → `batch/tracker-additions/`

Each offer also drops a short summary file here — a header row of column labels and one row of values. These get added to your main tracker in Step 6.

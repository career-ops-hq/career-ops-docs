...
icon: ScanEye
translationHash: 9c8815f39b224028
localized: true
...
<Callout title="Antes de empezar">
  Asegúrate de haber completado la guía de [Inicio rápido](/es/docs). Necesitas tener `cv.md` y `modes/_profile.md` en su sitio para que el escaneo sea útil.
</Callout>

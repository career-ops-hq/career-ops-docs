...
Ils complètent le [mode `interview-prep`](/fr/docs/reference/modes/interview-prep), plus ancien, qui construit votre socle durable (banque d'histoires, banque de questions). Les trois modes ciblés, eux, portent sur un *tour précis à venir*.

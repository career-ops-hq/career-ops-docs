...
icon: FileStack
translationHash: 2df1293340d4aead
localized: true
...
**Entrées de tracker** → `batch/tracker-additions/`

Chaque offre dépose également un court fichier de synthèse ici — une ligne d'en-tête avec les noms des colonnes et une ligne de valeurs. Ces fichiers seront ajoutés à votre tracker principal à l'étape 6.

...
career-ops finds the matching report in `reports/`, uses Playwright to open a browser window, and reads the form. It then drafts answers for supported text and free-response fields. Check their field limits before pasting. For Ashby, you will need your ordinary system browser to finish and submit the application.

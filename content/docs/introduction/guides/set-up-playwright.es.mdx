...
icon: Globe
translationHash: f5f0fe9c45cd1487
localized: true
...
<Callout title="Antes de empezar">
  Completa la guía de [inicio rápido](/es/docs). Node.js 18 o posterior (22.5+ recomendado) debe estar instalado y debes estar dentro de la carpeta raíz de career-ops.
</Callout>

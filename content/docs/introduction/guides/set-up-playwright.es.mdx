...
<Callout title="Antes de empezar">
  Completa la guía de [inicio rápido](/docs). Node.js 18 o posterior (22.5+ recomendado) debe estar instalado y debes estar dentro de la carpeta raíz de career-ops.
</Callout>
...
Para Ashby, Playwright puede inspeccionar el formulario y ayudar a redactar respuestas, pero termina y envía la candidatura en tu navegador habitual. Comprueba la página de éxito o el correo de confirmación antes de marcarla como enviada.

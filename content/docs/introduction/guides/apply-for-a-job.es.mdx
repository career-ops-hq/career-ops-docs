...
career-ops localiza el informe correspondiente en `reports/`, usa Playwright para abrir una ventana del navegador y lee el formulario. Después genera una respuesta para cada campo — lista para copiar y pegar. Para Ashby, tendrás que usar tu navegador habitual para terminar y enviar la candidatura.

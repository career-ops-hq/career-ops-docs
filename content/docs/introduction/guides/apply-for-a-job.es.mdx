...
icon: FileInput
translationHash: f2853d70ccab6f46
localized: true
...
<Callout title="Campos de subida de archivos">
  Usa el archivo de `output/` generado al crear el informe. Si todavía no existe ningún PDF, ejecuta primero `/career-ops pdf` y vuelve después al formulario. Consulta el [modo pdf](/es/docs/reference/modes/pdf).
</Callout>

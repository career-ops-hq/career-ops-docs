...
<Callout title="Envie de contribuer ?">
  Lisez le [guide de contribution](https://github.com/career-ops-hq/career-ops/blob/main/CONTRIBUTING.md) avant d'ouvrir une pull request. En résumé : ouvrez d'abord une issue pour discuter du changement, puis soumettez votre PR. Les mainteneurs relisent rapidement.
</Callout>

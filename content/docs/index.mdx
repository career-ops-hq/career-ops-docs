  ...
  <div className="rounded-xl bg-fd-background p-3">
    <Steps>
      ...
      <Step>
        ...
        Install **[Node.js](https://nodejs.org)** — minimum **18** (it works, with a warning), **22.5+ recommended** (it enables the SQLite tracker index). It runs the helper scripts and generates PDFs. Check your version with `node --version`. If you plan to use the Gemini CLI, that integration needs **Node 20 or newer**.
      </Step>
      <Step>
        ### Git

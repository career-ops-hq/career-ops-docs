...
career-ops works the same way in Cursor, Codex, OpenCode, Antigravity CLI, Grok Build CLI, Qwen, Kimi, Hermes Agent and GitHub Copilot CLI. See [Supported CLIs](/docs/supported-clis) for how each one loads it.

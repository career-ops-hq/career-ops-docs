...
- [docs/FAQ.md — « Skills aren't loading on Windows »](https://github.com/career-ops-hq/career-ops/blob/main/docs/FAQ.md) — la réponse canonique, maintenue en phase avec l'installeur.
- [docs/SETUP.md](https://github.com/career-ops-hq/career-ops/blob/main/docs/SETUP.md) — le guide d'installation complet.

Une fois l'installation terminée, choisissez votre moteur dans [Configurer un moteur d'IA gratuit](/fr/docs/free-ai-engine) ou utilisez n'importe quel [CLI pris en charge](/fr/docs/supported-clis), puis poursuivez avec le [Démarrage rapide](/docs).
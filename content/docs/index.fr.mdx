...
icon: Rocket
translationHash: 5b5d10d30b9bdad8
localized: true
translatedFrom: /docs
---
...
<Tabs items={["Claude Code", "Gemini CLI", "Codex", "Qwen Code", "OpenCode", "GitHub Copilot CLI", "Pi"]}>
...
Une fois l'onboarding terminé, vous êtes prêt à évaluer une vraie offre d'emploi. Copiez l'URL de n'importe quelle annonce et collez-la dans le chat. Avec Claude Code ou Pi, préfixez-la avec la commande explicite ; avec les autres CLI, collez l'URL et demandez à l'agent de lancer l'auto-pipeline :
...
<Tabs items={["Claude Code", "Gemini CLI", "Codex", "Qwen Code", "OpenCode", "GitHub Copilot CLI", "Pi"]}>
  ...
  <Tab value="Pi">
    ```bash
    /skill:career-ops auto-pipeline https://jobs.example.com/senior-engineer-ai
    ```
  </Tab>
</Tabs>

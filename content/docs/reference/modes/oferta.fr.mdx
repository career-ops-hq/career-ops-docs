...
translationHash: 2c8254029bcffc23
localized: true
...
Ce niveau décrit les preuves qui étayent le Global Score ; ce n'est ni une probabilité d'embauche ni le niveau de légitimité de l'annonce du bloc G, et il ne modifie pas la note numérique. Machine Summary conserve les cinq états dans `score_evidence`, le niveau dans `confidence` et les priorités dans `confidence_gaps`. Sans priorité restante, utilisez `confidence_gaps: []`.

## Pages liées

- [auto-pipeline](/fr/docs/reference/modes/auto-pipeline)
- [ofertas](/fr/docs/reference/modes/ofertas)

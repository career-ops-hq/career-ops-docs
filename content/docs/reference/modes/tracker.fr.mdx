...
translationHash: e628e938669001f5
localized: true
...
Tout ce qu'il ne peut pas reproduire est signalé sur stderr, et `--out` sur un fichier existant refuse d'écrire (code de sortie `1`, rien n'est écrit) tant que vous ne relancez pas avec `--force` :

...
icon: MonitorCheck
translationHash: 924bdf74881179f3
localized: true
...
- [docs/FAQ.md — "Skills aren't loading on Windows"](https://github.com/career-ops-hq/career-ops/blob/main/docs/FAQ.md) — la respuesta canónica, sincronizada con el instalador.
- [docs/SETUP.md](https://github.com/career-ops-hq/career-ops/blob/main/docs/SETUP.md) — guía completa de configuración.

Una vez instalado, elige tu motor en [Configura un motor de IA gratuito](/es/docs/free-ai-engine) o usa cualquier [CLI compatible](/es/docs/supported-clis), y después continúa con el [Inicio rápido](/es/docs).
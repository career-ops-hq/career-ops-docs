  ...
  <div className="rounded-xl bg-fd-background p-3">
    <Steps>
      ...
      <Step>
        ...
        Instala **[Node.js](https://nodejs.org)** — mínimo **18** (funciona, con una advertencia), **22.5+ recomendado** (habilita el índice SQLite del tracker). Ejecuta los scripts auxiliares y genera los PDFs. Comprueba tu versión con `node --version`. Si vas a usar Gemini CLI, esa integración necesita **Node 20 o posterior**.
      </Step>
      <Step>
        ### Git

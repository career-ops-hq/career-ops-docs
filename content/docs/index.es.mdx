...
icon: Rocket
translationHash: bc84e55a966b597c
localized: true
translatedFrom: /docs
---
...
<div className="rounded-lg bg-radial-[at_bottom] from-blue-500/20 p-4 border bg-origin-border border-fd-primary/10 prose-no-margin dark:bg-black/20">
  <div className="rounded-xl bg-fd-background p-3">
    <Steps>
      ...
      Instala **[Claude Code](https://claude.ai/code)**, **[Codex](https://developers.openai.com/codex/cli)**, **[OpenCode](https://opencode.ai/)**, **[Qwen Code](https://qwen.ai/qwencode)** o **[GitHub Copilot CLI](https://docs.github.com/en/copilot/github-copilot-in-the-cli)** — el asistente de programación con IA que ejecuta este sistema. career-ops funciona con [nueve CLIs con soporte de primera clase](/es/docs/supported-clis); instala cualquiera e inicia sesión antes de continuar.
      </Step>
      <Step>

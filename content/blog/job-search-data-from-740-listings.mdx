...
If you are running a search now and want to use a structured approach, [the repo](https://github.com/career-ops-hq/career-ops) is the place to start. If you want the comparison against the polished SaaS alternatives, [the comparisons are here](/compare). If you want to read the underlying thesis, [the founder's-thesis post is here](/blog/why-career-ops).
